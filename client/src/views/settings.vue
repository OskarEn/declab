    ...
    <div class="col-6">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <p
            class="mb-2"
          >The developer mode enables features like using raw JSON in the builder. It is intended for developers and should be used with caution.</p>
          <input
            type="checkbox"
            class="mb-4"
            v-model="configuration.developerMode"
            v-on:change="updateDeveloperMode"
          />
          ...
          <div class="d-flex">
            <div class="btn-group mb-0 mr-2">
              ...
              <button type="button" class="btn btn-outline-secondary">
                ...
                >
                  <path
                    d="M16.1 9l.9.9L7.9 19H7v-.9L16.1 9m3.6-6c-.2 0-.5.1-.7.3l-1.8 1.8 3.7 3.8L22.7 7c.4-.4.4-1 0-1.4l-2.3-2.3c-.2-.2-.5-.3-.7-.3m-3.6 3.2L5 17.2V21h3.8l11-11.1-3.7-3.7M8 5v-.5C8 3.1 6.9 2 5.5 2S3 3.1 3 4.5V5c-.6 0-1 .4-1 1v4c0 .6.4 1 1 1h5c.6 0 1-.4 1-1V6c0-.6-.4-1-1-1M7 5H4v-.5C4 3.7 4.7 3 5.5 3S7 3.7 7 4.5V5z"
                    fill="currentColor"
                  />
                </svg>
              </button>
              <button type="button" class="btn btn-outline-secondary">
                ...
                >
                  <path
                    d="M12 17a2 2 0 01-2-2c0-1.11.89-2 2-2a2 2 0 012 2 2 2 0 01-2 2m6 3V10H6v10h12m0-12a2 2 0 012 2v10a2 2 0 01-2 2H6a2 2 0 01-2-2V10c0-1.11.89-2 2-2h1V6a5 5 0 015-5 5 5 0 015 5v2h1m-6-5a3 3 0 00-3 3v2h6V6a3 3 0 00-3-3z"
                    fill="currentColor"
                  />
                </svg>
              </button>
    ...
    <div class="col-6">
      ...
      <div class="row">
        <div class="col-6">
          <div class="card mb-4">
            <div class="card-header">
              <h4 class="mb-0">Change Workspace Name</h4>
            </div>
            <!-- <div class="card-body">
              <div class="input-group">
				<input type="text" class="form-comtrol" placeholder="Enter new name"
        ...
        <div class="col-6">
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              >The deletion of workspaces is permanent and cannot be undone.</p>
...
export default {
  ...
  methods: {
    async importWorkspace(event) {
      ...
      this.$root.displayAlert(
        AlertHelper.buildList(
          (() => {
